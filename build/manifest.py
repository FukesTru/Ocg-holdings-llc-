...
PAGES = [
    ...
    dict(
        ...
        schema=[faq_schema([
            ...
            ("How quickly can we get started?", "Engagements begin with a consultation. From there, most clients reach financial clarity, meaning live reporting and a forward view of cash, in about 30 days."),
    ...
    dict(
        out="resources.html", prefix="", nav="insights", fragment="resources.html", priority="0.8",
        title="Financial Insights for Business Owners | OCG Financial",
        desc="Practical financial advice for business owners on cash flow, the gap between profit and cash, and building financial systems that make a business more valuable.",
        crumbs=[("Insights", None)],
    ),
    dict(
    ...
    dict(
        ...
        schema=[
            ...
            faq_schema([
                ...
                ("How long until I have real financial clarity?", "Most clients reach financial clarity in about 30 days, meaning live reporting, current books, and a forward view of cash."),
...
for slug, title, desc, date in _ARTICLES:
    PAGES.append(dict(
        ...
        desc=desc,
        crumbs=[("Insights", "resources.html"), (title[:46] + ("…" if len(title) > 46 else ""), None)],
